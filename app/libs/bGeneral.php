...
function cTexto(string $text, string $campo, array &$errores, int $max = 30, int $min = 3): bool
{
    if (preg_match("/^[a-zA-Z0-9_]{".$min.",".$max."}$/", $text)) {
        return true;
    }

    $errores[$campo] = "El usuario solo puede contener letras, números y _";
    return false;
}
